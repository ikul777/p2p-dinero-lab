            ...
            <div className="flex flex-col md:flex-row items-start gap-6">
              ...
              <div>
                ...
                <p className="text-gray-300 mb-4">
                  Я в темі P2P-арбітражу ще з тих часів, коли не було ніяких ком'юніті та гайдів – всі розбиралися самі, через помилки і втрати. Зараз я офіційний партнер топових крипто-бірж <a href="https://whitebit.com/a/35b66592-1a6b-473b-be2a-a27d105fee85" target="_blank" rel="noopener noreferrer" className="text-dinero-red hover:underline">WhiteBIT</a>, <a href="https://partner.bybit.com/b/136114" target="_blank" rel="noopener noreferrer" className="text-dinero-red hover:underline">Bybit</a> та <a href="https://www.okx.com/join/DINEROLAB" target="_blank" rel="noopener noreferrer" className="text-dinero-red hover:underline">OKX</a>, та засновник P2P-комʼюніті DineroLab.
                </p>
                <p className="text-gray-300 mb-4">
