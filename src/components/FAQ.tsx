...
const faqItems = [
  {
    ...
    answer: "Рекомендуємо мінімальний бюджет від $1000.  Наші звʼязки дозволять швидко збільшувати ваш бюджет вже в перші тижні роботи."
  },
  {
    question: "Чи можна почати без досвіду?",
    answer: "НІ, щоб приєднатись у DineroLab ти маєш мати мінімальні вміння в використанні бірж, банків та крипти. Ми надамо детальні інструкції та індивідуальну підтримку 24/7, але ти мусиш розуміти з чим працюєш."
  },
  {
