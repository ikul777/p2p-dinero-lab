...
const faqItems = [
  {
    ...
    answer: "Рекомендуємо мінімальний бюджет від $500. Оптимально мати 500-1000$. Наші звʼязки дозволять швидко збільшувати ваш бюджет вже в перші тижні роботи."
  },
  {
    question: "Чи можна почати без досвіду?",
    answer: "НІ, щоб приєднатись у DineroLab ти маєш мати мінімальні вміння в використанні бірж, банків та крипти. В нас є детальні інструкції та підтримка 24/7, але ти мусиш розуміти з чим працюєш."
  },
  {
