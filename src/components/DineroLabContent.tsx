...
const block1Points: Point[] = [
  ...
  { title: "P2P ЗВʼЯЗКИ", desc: "Актуальні авторські P2P-звʼязки з перевіреним профітом 4-8%. Торгівля на Українському та Європейському ринку. " },
...
const block3Points: Point[] = [
  { title: "ОРДЕР ПРОДАЖ", isNew: true, desc: "Гілка для обміну ордерами по продажу крипто активів та фіату учасниками та командою DineroLab, минаючи стакан біржі для отримання негайної ліквідності. Простими словами можливість заробляти внутнішньо в DineroLab." },
