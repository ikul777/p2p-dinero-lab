    ...
    <section id="join" className="py-10 sm:py-16 md:py-24 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="max-w-xl mx-auto">
          ...
          >
            <div className="animated-border p-6 sm:p-8 md:p-12 rounded-2xl">
              <div className="flex flex-col items-center text-center">
                <span className="tag mb-5 sm:mb-6 inline-block text-[10px] sm:text-xs">Приєднуйся зараз</span>

                <div className="relative mb-5 sm:mb-6">
                  <div className="absolute inset-0 bg-primary/25 rounded-full blur-2xl"></div>
                  <img
                    src={logoRed.url}
                    alt="DineroLab"
                    className="relative w-24 h-24 sm:w-32 sm:h-32 md:w-40 md:h-40 object-contain"
                  />
                </div>

                <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4 text-foreground text-balance">
                  Готовий заробляти з командою?
                </h2>

                <p className="text-sm sm:text-base text-muted-foreground mb-6 sm:mb-8 max-w-md text-balance">
